...
namespace Octopussy.Managers.BloomManager
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = Game.Content.Load<Effect>("shaders/bloom/BloomExtract");
            bloomCombineEffect = Game.Content.Load<Effect>("shaders/bloom/BloomCombine");
            gaussianBlurEffect = Game.Content.Load<Effect>("shaders/bloom/GaussianBlur");
